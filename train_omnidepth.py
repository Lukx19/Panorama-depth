...
experiment_name = 'omnidepth_uresnet_loss'
input_dir = '../datasets/' # Dataset location
train_file_list = '../datasets/original_train_split.txt' # File with list of training files
val_file_list = '../datasets/original_test_split.txt' # File with list of validation files
